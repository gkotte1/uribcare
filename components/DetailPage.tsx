...
/**
 * Renders a service or ecosystem detail page from a single `Detail` record,
 * reusing the section styles the home page already uses (`.band`, `.eco-card`,
 * `.aud-card`, `.trust-card`, `.feature-band`, `.journey`, `.cta-final`).
 */
          ...
          <div className="wrap">
            {image ? (
              <div className="split">
                ...
                <figure className="fb-photo reveal">
          ...
          <div className="wrap">
            ...
            <div className="journey">
              {process.steps.map((step, i) => (
                <div className="jrow reveal" key={step.title}>
