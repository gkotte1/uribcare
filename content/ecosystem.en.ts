...
const shared = (slug: string) => summary(ECOSYSTEM_NAV.en, slug);
 ...
 */
export const ECOSYSTEM_EN: Detail[] = [
  {
    kind: 'ecosystem',
    ...
    process: {
      ...
      steps: [
        ...
        { label: 'Step 3', title: 'Consult with full history', text: 'The physician opens the shared record, with diagnoses, therapy notes and past results already in place.' },
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        'A prescription is only useful once it is filled, taken, and refilled on time. That handover, from consult to pharmacy to patient to refill, is where a surprising amount of treatment quietly fails.',
      ...
      groups: [
        ...
        },
        {
          ...
          points: [
            ...
            'Fewer clarification calls, because the prescription arrives with context',
